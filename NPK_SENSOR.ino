...
static const PROGMEM u1_t NWKSKEY[16] = { 0xd8, 0x16, 0x66, 0x2d, 0xca, 0xad, 0xae, 0x16, 0x50, 0x26, 0x52, 0x8b, 0xc3, 0xb6, 0xd8, 0x98 };

// LoRaWAN AppSKey, application session key
// This should also be in big-endian (aka msb).
static const u1_t PROGMEM APPSKEY[16] = { 0x0d, 0x3d, 0x01, 0x29, 0x18, 0x32, 0x24, 0xb2, 0x66, 0xe6, 0x2d, 0xa2, 0x20, 0xe5, 0x24, 0x9c };

// LoRaWAN end-device address (DevAddr)
// See http://thethingsnetwork.org/wiki/AddressSpace
// The library converts the address to network byte order as needed, so this should be in big-endian (aka msb) too.
static const u4_t DEVADDR = 0x00c7ff43 ; // <-- Change this address for every node!
